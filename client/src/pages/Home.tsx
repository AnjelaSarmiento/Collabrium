    ...
    <div className="max-w-7xl mx-auto">
      ...
      {isAuthenticated && user && (
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-8">
          <h2 className="text-lg font-medium text-secondary-900 mb-4">Your Stats</h2>
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-2xl font-semibold text-secondary-900">{user.completedCollaborations || 0}</p>
                </div>
              </div>
            </div>
            <div className="bg-yellow-50 rounded-lg p-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-secondary-500">Skills</p>
                  <p className="text-2xl font-semibold text-secondary-900">{user.skills?.length || 0}</p>
                </div>
              </div>
            </div>
          </div>
