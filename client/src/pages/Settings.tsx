  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-secondary-600 mt-2">Manage your account preferences and settings</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-secondary-200">
        ...
        <div className="p-6">
          ...
          {activeTab === 'wallet' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-medium text-secondary-900 mb-4">Wallet Preferences</h3>
                    ...
                    <div className="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                      ...
                      <button
                        ...
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          walletSettings.autoAcceptPayments ? 'bg-primary-600' : 'bg-secondary-300'
                        }`}
                      >
                        <span
          ...
          {activeTab === 'notifications' && (
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        preferences.soundEnabled ? 'bg-primary-600' : 'bg-secondary-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                  ...
                  <div className="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        preferences.emailNotifications ? 'bg-primary-600' : 'bg-secondary-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                  ...
                  <div className="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        preferences.inAppAlerts ? 'bg-primary-600' : 'bg-secondary-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                  ...
                  <div className="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                        {preferences.showPreview ? (
                          ...
                          <EyeSlashIcon className="h-6 w-6 text-secondary-400" />
                        )}
                      </div>
                      <div className="ml-4">
                        <label className="block text-sm font-medium text-secondary-700">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        preferences.showPreview ? 'bg-primary-600' : 'bg-secondary-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              {/* Notification Types */}
              <div>
                <h3 className="text-lg font-medium text-secondary-900 mb-4">Notification Types</h3>
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`relative ml-4 inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          preferences.notificationTypes[type.key] ? 'bg-primary-600' : 'bg-secondary-300'
                        }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
              ...
              {/* Do Not Disturb Mode */}
              <div>
                <h3 className="text-lg font-medium text-secondary-900 mb-4">Do Not Disturb Mode</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                        preferences.doNotDisturb.enabled ? 'bg-primary-600' : 'bg-secondary-300'
                      }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                  ...
                  {preferences.doNotDisturb.enabled && (
                    <div className="ml-10 space-y-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
